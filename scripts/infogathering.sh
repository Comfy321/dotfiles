...
ping -c 1 google.com &> /dev/null && echo -e -n '\E[32m'"Internet: $tecreset Connected" || echo -e -n '\E[32m'"Internet: $tecreset Disconnected"

# Check OS Type
os=$(uname -o)
echo -e -n'\E[32m'"Operating System Type :" $tecreset $os
